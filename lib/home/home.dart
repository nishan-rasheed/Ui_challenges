...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin{
  ...
  List<Pizza> myPizzas = [
    ...
    Pizza(
        ...
        pizzaImage: 'assets/pizzas/car.png', //'assets/pizzas/pizza2.png',
        pizzaPriceS: 7,
        pizzaPriceM: 10,
        pizzaPriceL: 12),
    Pizza(
        ...
        child: Column(
          children: [
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: Transform.rotate(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      log('parent--$parent-currentPageValue$currentPageValue');
                                    },
                                    child: Image.asset(
            ...
            Transform.rotate(
              ...
              child: InkWell(
                onTap: () {
                  log((pizzaSize-100).toString());
                },
                child: Image.asset(myPizzas[1].pizzaImage,
                height: pizzaSize-100,
                ),
              ),
            ),
